...
(function (window, document) {
  ...
  ROY.mountThumb = function (canvas, simId, values) {
    ...
    /* Миниатюра стартует не с нуля: несколько сотен шагов дают узнаваемую
       картинку, а не пустую бумагу с одной точкой. Шаги идут порциями
       между кадрами, чтобы не подвешивать страницу при загрузке. */
    ROY.warmupLater(scene, THUMB_WARM[simId] || 320);
    return scene;
  };
